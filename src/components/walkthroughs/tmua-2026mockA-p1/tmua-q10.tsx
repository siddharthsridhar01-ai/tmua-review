...
const META = { questionNumber: 10, set: "A", paperNumber: "Paper 1", topicTag: "Translations / Completing the Square" };
...
const SECTIONS_Q10 = [
  { type: "prose", text: (<>A sequence of translations is applied to the graph of <Tex>{"y = x^2"}</Tex>.</>) },
  { type: "prose", text: (<>Which of the following graphs could be the result of this sequence of translations?</>) },
];
const OPTIONS_Q10 = [["A", "\\text{none}"], ["B", "\\text{I only}"], ["C", "\\text{II only}"], ["D", "\\text{III only}"], ["E", "\\text{I and II only}"], ["F", "\\text{I and III only}"], ["G", "\\text{II and III only}"], ["H", "\\text{I, II and III}"]];
