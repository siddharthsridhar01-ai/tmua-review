...
const META = { questionNumber: 20, set: "A", paperNumber: "Paper 1", topicTag: "Hidden Circle / Logarithm Equation" };
...
const SECTIONS_Q20 = [
  ...
  { type: "mathbox", tex: "\\log_{10}(x^2 + y^2) = 1 + \\log_{10}(2y - 2x)" },
];
const OPTIONS_Q20 = [["A", "50\\pi"], ["B", "100\\pi"], ["C", "200\\pi"], ["D", "400\\pi"], ["E", "10\\sqrt{2}\\,\\pi"], ["F", "20\\sqrt{2}\\,\\pi"]];
