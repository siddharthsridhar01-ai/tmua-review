...
const META = { questionNumber: 4, set: "A", paperNumber: "Paper 1", topicTag: "Exponentials / Completing the Square" };
...
const SECTIONS_Q4 = [
  { type: "prose", text: (<>Find the minimum value of</>) },
  { type: "mathbox", tex: "4^x - 6 \\cdot 2^x + 10" },
];
const OPTIONS_Q4 = [["A", "-4"], ["B", "-1"], ["C", "0"], ["D", "1"], ["E", "2"], ["F", "5"]];
