...
const META = { questionNumber: 11, set: "A", paperNumber: "Paper 1", topicTag: "Telescoping Series / Logarithms" };
...
const SECTIONS_Q11 = [
  ...
  { type: "mathbox", tex: "\\sum_{n=1}^{99} \\log_{10}\\!\\left(\\frac{n+1}{n}\\right)" },
];
const OPTIONS_Q11 = [["A", "-2"], ["B", "-1"], ["C", "0"], ["D", "1"], ["E", "2"], ["F", "\\log_{10} 99"]];
