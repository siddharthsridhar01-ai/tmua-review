...
const META = { questionNumber: 3, set: "A", paperNumber: "Paper 1", topicTag: "Sequences / AP & GP" };
...
const SECTIONS_Q3 = [
  { type: "prose", text: (<>An arithmetic progression and a convergent geometric progression each have first term <Tex>{"3"}</Tex>.</>) },
  { type: "prose", text: (<>The sum of their second terms is <Tex>{"5"}</Tex>.</>) },
  { type: "prose", text: (<>The sum of their third terms is <Tex>{"\\tfrac{13}{3}"}</Tex>.</>) },
  { type: "prose", text: (<>What is the sum to infinity of the geometric progression?</>) },
];
const OPTIONS_Q3 = [["A", "4"], ["B", "6"], ["C", "8"], ["D", "9"], ["E", "12"], ["F", "18"]];
