...
const META = { questionNumber: 5, set: "A", paperNumber: "Paper 1", topicTag: "Recurrence Relations" };
...
const SECTIONS_Q5 = [
  { type: "prose", text: (<>The terms <Tex>{"x_n"}</Tex> of a sequence follow the rule</>) },
  { type: "mathbox", tex: "x_{n+1} = \\frac{x_n + p}{x_n + q}" },
  { type: "prose", text: (<>where <Tex>{"p"}</Tex> and <Tex>{"q"}</Tex> are real numbers.</>) },
  { type: "prose", text: (<>Given that <Tex>{"x_1 = 2"}</Tex>, <Tex>{"x_2 = 4"}</Tex>, and <Tex>{"x_3 = 3"}</Tex>, find the value of <Tex>{"x_5"}</Tex>.</>) },
];
const OPTIONS_Q5 = [["A", "-5"], ["B", "-\\tfrac{5}{3}"], ["C", "\\tfrac{11}{5}"], ["D", "\\tfrac{29}{9}"], ["E", "\\tfrac{17}{3}"], ["F", "13"]];
