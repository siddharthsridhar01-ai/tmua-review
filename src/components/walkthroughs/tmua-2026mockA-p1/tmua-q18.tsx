...
const META = { questionNumber: 18, set: "A", paperNumber: "Paper 1", topicTag: "Geometric Series / Probability" };
...
const SECTIONS_Q18 = [
  { type: "prose", text: (<>You are given that</>) },
  { type: "mathbox", tex: "S = 5 + 5\\!\\left(\\frac{3k}{10}\\right) + 5\\!\\left(\\frac{3k}{10}\\right)^{\\!2} + \\cdots" },
  { type: "prose", text: (<>The integer <Tex>{"k"}</Tex> is chosen uniformly at random from <Tex>{"-3 \\le k \\le 3"}</Tex>.</>) },
  { type: "prose", text: (<>What is the probability that <Tex>{"S"}</Tex> is a finite number greater than <Tex>{"8"}</Tex>?</>) },
];
const OPTIONS_Q18 = [["A", "\\tfrac{1}{7}"], ["B", "\\tfrac{2}{7}"], ["C", "\\tfrac{3}{7}"], ["D", "\\tfrac{4}{7}"], ["E", "\\tfrac{5}{7}"], ["F", "\\tfrac{6}{7}"]];
