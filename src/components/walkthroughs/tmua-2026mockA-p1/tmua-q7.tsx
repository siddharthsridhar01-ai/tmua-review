...
const META = { questionNumber: 7, set: "A", paperNumber: "Paper 1", topicTag: "Modulus / Integration / Symmetry" };
...
const SECTIONS_Q7 = [
  { type: "prose", text: (<>Find the finite area enclosed between the line <Tex>{"y = 0"}</Tex> and the curve</>) },
  { type: "mathbox", tex: "y = x^2 - 6|x| + 5" },
];
const OPTIONS_Q7 = [["A", "\\tfrac{32}{3}"], ["B", "16"], ["C", "\\tfrac{56}{3}"], ["D", "\\tfrac{64}{3}"], ["E", "24"], ["F", "32"]];
