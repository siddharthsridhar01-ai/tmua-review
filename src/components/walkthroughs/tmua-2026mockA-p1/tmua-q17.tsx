...
const META = { questionNumber: 17, set: "A", paperNumber: "Paper 1", topicTag: "Nested Squares / Summation" };
...
const SECTIONS_Q17 = [
  { type: "prose", text: (<>A square <Tex>{"S_n"}</Tex> has vertices at <Tex>{"(\\pm n, \\pm n)."}</Tex></>) },
  { type: "prose", text: (<><Tex>{"S_1"}</Tex> and <Tex>{"S_2"}</Tex> are drawn and the region between them is shaded. Then <Tex>{"S_3"}</Tex> and <Tex>{"S_4"}</Tex> are drawn and the region between them is shaded. This is shown in the diagram.</>) },
  { type: "prose", text: (<>This continues until <Tex>{"50"}</Tex> squares have been drawn. What is the total shaded area?</>) },
];
const OPTIONS_Q17 = [["A", "2500"], ["B", "3400"], ["C", "4800"], ["D", "5100"], ["E", "5200"], ["F", "10200"]];
