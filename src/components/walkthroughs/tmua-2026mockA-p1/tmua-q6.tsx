...
const META = { questionNumber: 6, set: "A", paperNumber: "Paper 1", topicTag: "Trig Identities / Range of Functions" };
...
const SECTIONS_Q6 = [
  { type: "prose", text: (<>The function <Tex>{"f"}</Tex> is given by</>) },
  { type: "mathbox", tex: "f(x) = \\frac{\\sin x + 2}{5 + 4\\sin x - \\cos^2 x}" },
  { type: "prose", text: (<>Find the positive difference between the maximum and the minimum values of <Tex>{"f(x)"}</Tex>.</>) },
];
const OPTIONS_Q6 = [["A", "0"], ["B", "\\tfrac{1}{3}"], ["C", "\\tfrac{1}{2}"], ["D", "\\tfrac{2}{3}"], ["E", "1"], ["F", "2"]];
