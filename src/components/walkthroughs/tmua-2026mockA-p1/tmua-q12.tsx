...
const META = { questionNumber: 12, set: "A", paperNumber: "Paper 1", topicTag: "Quartic Minimum / Completing the Square" };
...
const SECTIONS_Q12 = [
  { type: "prose", text: (<>The minimum value of the function</>) },
  { type: "mathbox", tex: "x^4 - 2kx^2" },
  { type: "prose", text: (<>is <Tex>{"-4"}</Tex>, where <Tex>{"k > 0"}</Tex>.</>) },
  { type: "prose", text: (<>Find the minimum value of the function</>) },
  { type: "mathbox", tex: "x^2 - 2kx + 5" },
];
const OPTIONS_Q12 = [["A", "-3"], ["B", "-1"], ["C", "0"], ["D", "1"], ["E", "3"], ["F", "5"]];
