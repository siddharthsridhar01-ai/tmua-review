  ...
  const graph = (() => {
    ...
    return (
      <svg viewBox={`0 0 ${pW} ${pH}`} width={pW} style={{ display: "block", width: "100%" }}>
        ...
        <foreignObject x={sx(xVal) - 48} y={sy(fMinus) - 12 - 13} width={96} height={20}><div style={{ fontSize: 11, color: C.white, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{`(${fmt(xVal / Math.PI)}{"\\u03C0"}, ${fmt(fMinus)})`}</Tex></div></foreignObject>
        <foreignObject x={pW - pad.r - 4 - 80} y={sy(-3) + 14 - 13} width={80} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "right", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", marginLeft: "auto" }}><Tex>{"min = -3"}</Tex></div></foreignObject>
        <foreignObject x={sx(0.3)} y={sy(fP(0.3)) - 8 - 13} width={160} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "left", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"f+ = (3cos x + \\sqrt(5cos^2x + 4))/2"}</Tex></div></foreignObject>
        <foreignObject x={sx(0.3)} y={sy(fM(0.3)) + 16 - 13} width={160} height={20}><div style={{ fontSize: 11, color: C.ps, textAlign: "left", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"f- = (3cos x - \\sqrt(5cos^2x + 4))/2"}</Tex></div></foreignObject>
        {[0, 1, 2].map(n => <foreignObject key={n} x={sx(n * Math.PI) - 16} y={pH - pad.b + 14 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{`{n === 0 ? "0" : n === 1 ? "\\u03C0" : "2\\u03C0"}`}</Tex></div></foreignObject>)}
        {[-3, -2, -1, 1, 2, 3].map(y => y >= yMin && y <= yMax && <foreignObject key={y} x={pad.l - 8 - 32} y={sy(y) + 4 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "right", lineHeight: 1, fontWeight: 400, fontStyle: "normal", marginLeft: "auto" }}><Tex>{"y"}</Tex></div></foreignObject>)}
      </svg>
    );
  })();
  return (
