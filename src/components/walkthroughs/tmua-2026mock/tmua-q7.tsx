...
function ModCurveGraph({ compact, showBothPockets }) {
  ...
  return (
    <svg viewBox={`0 0 ${pW} ${pH}`} width={pW} style={{ display: "block", width: "100%" }}>
      ...
      {/* Labels */}
      {!compact && <>
        <foreignObject x={sx(1) - 15} y={sy(0) + 14 - 13} width={30} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"1"}</Tex></div></foreignObject>
        <foreignObject x={sx(5) - 15} y={sy(0) + 14 - 13} width={30} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"5"}</Tex></div></foreignObject>
        <foreignObject x={sx(-1) - 16} y={sy(0) + 14 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"-1"}</Tex></div></foreignObject>
        <foreignObject x={sx(-5) - 16} y={sy(0) + 14 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"-5"}</Tex></div></foreignObject>
        <foreignObject x={sx(0) + 6} y={pad.t + 12 - 13} width={160} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "left", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"y = x^2 - 6|x| + 5"}</Tex></div></foreignObject>
      </>}
      {compact && <>
        <foreignObject x={sx(1) - 15} y={sy(0) + 13 - 13} width={30} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"1"}</Tex></div></foreignObject>
        <foreignObject x={sx(5) - 15} y={sy(0) + 13 - 13} width={30} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"5"}</Tex></div></foreignObject>
        <foreignObject x={sx(-1) - 16} y={sy(0) + 13 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"-1"}</Tex></div></foreignObject>
        <foreignObject x={sx(-5) - 16} y={sy(0) + 13 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"-5"}</Tex></div></foreignObject>
      </>}
      {[-4, -2, 2, 4, 6].map(x => <foreignObject key={`lx${x}`} x={sx(x) - 16} y={pH - pad.b + 14 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"x"}</Tex></div></foreignObject>)}
      {[-4, -2, 2, 4, 6].map(y => y >= yMin && y <= yMax && <foreignObject key={`ly${y}`} x={pad.l - 8 - 32} y={sy(y) + 4 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "right", lineHeight: 1, fontWeight: 400, fontStyle: "normal", marginLeft: "auto" }}><Tex>{"y"}</Tex></div></foreignObject>)}
    </svg>
  );
}
