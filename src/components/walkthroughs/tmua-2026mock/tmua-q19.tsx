...
function SolveStepContent({ revealed, setRevealed }) {
  const mkGraph = (drawFn, opts) => {
    ...
    return (
      <svg viewBox={`0 0 ${pW} ${pH}`} width={pW} style={{ display: "block", width: "100%" }}>
        ...
        {[0, 1, 2, 3, 4].map(x => <foreignObject key={x} x={sx(x) - 16} y={pH - pad.b + 13 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"x"}</Tex></div></foreignObject>)}
      </svg>
    );
  };
  ...
  const derivGraph = mkGraph((sx, sy) => {
    ...
    return (<>
      ...
      <foreignObject x={sx(0.2)} y={sy(2) - 6 - 13} width={30} height={20}><div style={{ fontSize: 11, color: c1, textAlign: "left", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"2"}</Tex></div></foreignObject>
      <foreignObject x={sx(2) - 28} y={sy(g(2)) - 6 - 13} width={56} height={20}><div style={{ fontSize: 11, color: c2, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"4-2x"}</Tex></div></foreignObject>
      <foreignObject x={sx(4) - 20} y={sy(-2) - 6 - 13} width={40} height={20}><div style={{ fontSize: 11, color: c3, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"-2"}</Tex></div></foreignObject>
    </>);
  ...
  const antiderivGraph = mkGraph((sx, sy) => {
    ...
    return (<>
      ...
      <foreignObject x={sx(2) - 32} y={sy(f(2)) - 8 - 13} width={64} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"(2, 3)"}</Tex></div></foreignObject>
      <foreignObject x={sx(0) + 8} y={sy(0) + 14 - 13} width={64} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "left", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"(0, 0)"}</Tex></div></foreignObject>
      <foreignObject x={sx(4) - 4 - 64} y={sy(0) + 14 - 13} width={64} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "right", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", marginLeft: "auto" }}><Tex>{"(4, 0)"}</Tex></div></foreignObject>
    </>);
  ...
  const graph = (() => {
    ...
    return (
      <svg viewBox={`0 0 ${pW} ${pH}`} width={pW} style={{ display: "block", width: "100%" }}>
        ...
        <foreignObject x={sx(1) - 28} y={pad.t + 12 - 13} width={56} height={20}><div style={{ fontSize: 11, color: C.text + "88", textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"x = 1"}</Tex></div></foreignObject>
        <foreignObject x={sx(3) - 28} y={pad.t + 12 - 13} width={56} height={20}><div style={{ fontSize: 11, color: C.text + "88", textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"x = 3"}</Tex></div></foreignObject>
        ...
        <foreignObject x={sx(0.5) - 32} y={sy(1) + 2 - 13} width={64} height={20}><div style={{ fontSize: 11, color: c1, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"f = 2x"}</Tex></div></foreignObject>
        <foreignObject x={sx(2) - 64} y={sy(2) - 13} width={128} height={20}><div style={{ fontSize: 11, color: c2, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"f = 4x-x^2-1"}</Tex></div></foreignObject>
        <foreignObject x={sx(3.5) - 44} y={sy(1) + 2 - 13} width={88} height={20}><div style={{ fontSize: 11, color: c3, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"f = 8-2x"}</Tex></div></foreignObject>
        ...
        <foreignObject x={sx(0) - 4 - 80} y={sy(f(0)) - 10 - 13} width={80} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "right", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", marginLeft: "auto" }}><Tex>{"f(0) = 0"}</Tex></div></foreignObject>
        <foreignObject x={sx(2) - 40} y={sy(f(2)) - 10 - 13} width={80} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{"f(2) = 3"}</Tex></div></foreignObject>
        <foreignObject x={sx(4) + 4} y={sy(f(4)) - 10 - 13} width={80} height={20}><div style={{ fontSize: 11, color: C.ok, textAlign: "left", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content" }}><Tex>{"f(4) = 0"}</Tex></div></foreignObject>
        {/* Moving dot on f(x) */}
        <circle cx={sx(xVal)} cy={sy(fVal)} r={6} fill={col} stroke={C.white} strokeWidth={1.5} />
        <foreignObject x={sx(xVal) - 40} y={sy(fVal) - 14 - 13} width={80} height={20}><div style={{ fontSize: 11, color: C.white, textAlign: "center", lineHeight: 1, fontWeight: 600, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", margin: "0 auto" }}><Tex>{`(${fmt(xVal)}, ${fmt(fVal)})`}</Tex></div></foreignObject>
        {/* Moving dot on dy/dx */}
        <circle cx={sx(xVal)} cy={sy(gVal)} r={4} fill={C.assum} stroke={C.white} strokeWidth={1} />
        {/* dy/dx label */}
        <foreignObject x={pW - pad.r - 4 - 56} y={sy(-2) + 14 - 13} width={56} height={20}><div style={{ fontSize: 11, color: C.assum, textAlign: "right", lineHeight: 1, fontWeight: 400, fontStyle: "normal", background: "rgba(15,17,23,0.7)", borderRadius: 2, padding: "0 2px", width: "fit-content", marginLeft: "auto" }}><Tex>{"dy/dx"}</Tex></div></foreignObject>
        {/* Axis labels */}
        {[0, 1, 2, 3, 4].map(x => <foreignObject key={x} x={sx(x) - 16} y={pH - pad.b + 14 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "center", lineHeight: 1, fontWeight: 400, fontStyle: "normal", margin: "0 auto" }}><Tex>{"x"}</Tex></div></foreignObject>)}
        {[-2, -1, 1, 2, 3].map(y => <foreignObject key={y} x={pad.l - 8 - 32} y={sy(y) + 4 - 13} width={32} height={20}><div style={{ fontSize: 11, color: C.muted, textAlign: "right", lineHeight: 1, fontWeight: 400, fontStyle: "normal", marginLeft: "auto" }}><Tex>{"y"}</Tex></div></foreignObject>)}
      </svg>
    );
  })();
