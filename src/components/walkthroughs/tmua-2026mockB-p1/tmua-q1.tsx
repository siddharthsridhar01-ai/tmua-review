...
const META = { questionNumber: 1, set: "B", paperNumber: "Paper 1", topicTag: "Integration / Simultaneous Equations" };
...
const SECTIONS_Q1 = [
  { type: "prose", text: (<>Given that</>) },
  { type: "mathbox", tex: "\\int_0^1 (px + q)\\,dx = 5 \\qquad \\text{and} \\qquad \\int_0^1 x(px + q)\\,dx = 3" },
  { type: "prose", text: (<>find the value of <Tex>{"p + q"}</Tex>.</>) },
];
const OPTIONS_Q1 = [["A", "2"], ["B", "4"], ["C", "6"], ["D", "8"], ["E", "10"], ["F", "12"]];
