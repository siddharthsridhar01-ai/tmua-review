...
const META = { questionNumber: 5, set: "B", paperNumber: "Paper 1", topicTag: "Geometry / Quadratic Constraint" };
...
const SECTIONS_Q5 = [
  { type: "prose", text: (<>An equilateral triangle of side 8 has a rectangle inscribed with one side along the base. The rectangle has height <Tex>{"h"}</Tex>.</>) },
  { type: "prose", text: (<>What is the largest value of <Tex>{"h"}</Tex> such that the area of the rectangle is <Tex>{"6\\sqrt{3}"}</Tex>?</>) },
];
const OPTIONS_Q5 = [["A", "\\sqrt{3}"], ["B", "2\\sqrt{3}"], ["C", "3\\sqrt{3}"], ["D", "4\\sqrt{3}"], ["E", "3"], ["F", "6"]];
