...
const META = { questionNumber: 18, set: "B", paperNumber: "Paper 1", topicTag: "Transformations / Rotation" };
...
const SECTIONS_Q18 = [
  { type: "prose", text: (<>The curve with equation</>) },
  { type: "mathbox", tex: "y = (x - 1)^2 + 2" },
  { type: "prose", text: (<>is rotated <Tex>{"90"}</Tex> degrees clockwise about the point <Tex>{"(3, 2)"}</Tex> to give the curve C.</>) },
  { type: "prose", text: (<>What is the equation of C?</>) },
];
const OPTIONS_Q18 = [["A", "x = (4 - y)^2 + 3"], ["B", "x = -(4 - y)^2 + 3"], ["C", "y = (x - 4)^2 + 3"], ["D", "y = -(x - 3)^2 + 4"], ["E", "x = (y - 4)^2 + 3"], ["F", "y = -(x - 4)^2 - 3"]];
