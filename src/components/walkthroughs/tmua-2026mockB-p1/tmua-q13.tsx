...
const META = { questionNumber: 13, set: "B", paperNumber: "Paper 1", topicTag: "Circles / Coordinate Geometry" };
...
const SECTIONS_Q13 = [
  { type: "prose", text: (<>Point P lies on the circle</>) },
  { type: "mathbox", tex: "(x - 2)^2 + (y + 1)^2 = 9" },
  { type: "prose", text: (<>Point Q lies on the circle</>) },
  { type: "mathbox", tex: "(x + 3)^2 + (y - 3)^2 = 4" },
  { type: "prose", text: (<>What is the maximum possible length of PQ?</>) },
];
const OPTIONS_Q13 = [["A", "5"], ["B", "5 + \\sqrt{41}"], ["C", "\\sqrt{41} + 3"], ["D", "5 + 2\\sqrt{41}"], ["E", "10"], ["F", "\\sqrt{41}"]];
