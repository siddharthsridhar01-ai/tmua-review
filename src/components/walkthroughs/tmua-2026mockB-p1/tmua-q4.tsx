...
const META = { questionNumber: 4, set: "B", paperNumber: "Paper 1", topicTag: "Series / Trig + Geometric Sum" };
...
const SECTIONS_Q4 = [
  { type: "prose", text: (<>Evaluate</>) },
  { type: "mathbox", tex: "\\sum_{n=0}^{\\infty} \\cos\\!\\left(n\\pi + \\frac{\\pi}{3}\\right) \\cdot \\left(\\frac{1}{3}\\right)^{\\!n}" },
];
const OPTIONS_Q4 = [["A", "0"], ["B", "\\tfrac{1}{4}"], ["C", "\\tfrac{3}{8}"], ["D", "\\tfrac{1}{2}"], ["E", "\\tfrac{3}{4}"], ["F", "1"]];
