...
const META = { questionNumber: 9, set: "B", paperNumber: "Paper 1", topicTag: "Coordinate Geometry / Absolute Value" };
...
const SECTIONS_Q9 = [
  { type: "prose", text: (<>Find the area enclosed by the curve</>) },
  { type: "mathbox", tex: "|x - 1| + |y + 2| = 3" },
];
const OPTIONS_Q9 = [["A", "9"], ["B", "12"], ["C", "15"], ["D", "18"], ["E", "24"], ["F", "36"]];
