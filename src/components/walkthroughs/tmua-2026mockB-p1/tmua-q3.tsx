...
const META = { questionNumber: 3, set: "B", paperNumber: "Paper 1", topicTag: "Calculus / Second Derivative Conditions" };
...
const SECTIONS_Q3 = [
  { type: "prose", text: (<>Given the following statements about a function f:</>) },
  { type: "mathbox", tex: "f''(x) = a \\text{ for all } x, \\quad f(0) = 2, \\quad f(1) = 3, \\quad \\int_0^1 f(x)\\,dx = 3" },
  { type: "prose", text: (<>Find the value of <Tex>{"a"}</Tex>.</>) },
];
const OPTIONS_Q3 = [["A", "-6"], ["B", "-3"], ["C", "-2"], ["D", "2"], ["E", "3"], ["F", "6"]];
