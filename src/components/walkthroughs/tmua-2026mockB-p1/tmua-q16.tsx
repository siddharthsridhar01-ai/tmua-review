...
const META = { questionNumber: 16, set: "B", paperNumber: "Paper 1", topicTag: "Coordinate Geometry / Perpendicular Gradients" };
...
const SECTIONS_Q16 = [
  { type: "prose", text: (<>A right-angled triangle has vertices at <Tex>{"(0, 1)"}</Tex>, <Tex>{"(8, 5)"}</Tex> and <Tex>{"(2, k)"}</Tex>.</>) },
  { type: "prose", text: (<>Find the sum of all possible values of <Tex>{"k"}</Tex>.</>) },
];
const OPTIONS_Q16 = [["A", "16"], ["B", "18"], ["C", "20"], ["D", "22"], ["E", "24"], ["F", "28"]];
