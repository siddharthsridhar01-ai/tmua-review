...
const META = { questionNumber: 10, set: "B", paperNumber: "Paper 1", topicTag: "Integration / Trapezium Rule" };
...
const SECTIONS_Q10 = [
  { type: "prose", text: (<>The trapezium rule with <Tex>{"2"}</Tex> strips is used to estimate</>) },
  { type: "mathbox", tex: "\\int_0^4 \\sqrt{16 - x^2}\\,dx" },
  { type: "prose", text: (<>What is the positive difference between the estimate and the exact value?</>) },
];
const OPTIONS_Q10 = [["A", "4(\\pi - 1 - \\sqrt{3})"], ["B", "4\\pi - 4 - 4\\sqrt{3}"], ["C", "4\\pi - 4"], ["D", "2(\\pi - 1 - \\sqrt{3})"], ["E", "4\\pi - 2\\sqrt{3}"]];
