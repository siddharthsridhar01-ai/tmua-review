...
const META = { questionNumber: 2, set: "B", paperNumber: "Paper 1", topicTag: "Quadratics / Discriminant Inequality" };
...
const SECTIONS_Q2 = [
  { type: "prose", text: (<>The graphs of</>) },
  { type: "mathbox", tex: "y = x^2 - 6x + 10 \\qquad \\text{and} \\qquad y = mx + 1" },
  { type: "prose", text: (<>where <Tex>{"m"}</Tex> is a constant, do not intersect.</>) },
  { type: "prose", text: (<>What is the complete range of values of <Tex>{"m"}</Tex>?</>) },
];
const OPTIONS_Q2 = [["A", "-12 < m < 0"], ["B", "m < -12 \\text{ or } m > 0"], ["C", "-6 < m < 6"], ["D", "0 < m < 12"], ["E", "m < 0 \\text{ or } m > 12"]];
