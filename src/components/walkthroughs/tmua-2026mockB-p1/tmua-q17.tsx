...
const META = { questionNumber: 17, set: "B", paperNumber: "Paper 1", topicTag: "Trigonometry / Ambiguous Case" };
...
const opts = [
  ...
  { letter: "D", ok: true, tex: "3 < x < 4", expl: "Two non-congruent triangles require: (1) both sides positive: 1 < x < 5, (2) a < b: x < 4, (3) a > b \u00D7 sin 30\u00B0: x > 3. The intersection is 3 < x < 4." },
  ...
  { letter: "F", ok: false, tex: "4 < x < 5", expl: "You might get this by swapping which side is a and which is b, or by reversing the a < b inequality." },
];
...
const SECTIONS_Q17 = [
  { type: "prose", text: (<>Find the complete set of values of <Tex>{"x"}</Tex> for which there are two non-congruent triangles with the side lengths and angle as shown in the diagram.</>) },
];
const OPTIONS_Q17 = [["A", "1 < x < 3"], ["B", "1 < x < 4"], ["C", "1 < x < 5"], ["D", "3 < x < 4"], ["E", "3 < x < 5"], ["F", "4 < x < 5"]];
...
function ReadStep() {
  ...
  return (<div><div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "18px 22px", marginBottom: 14 }}><div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}><span style={{ background: C.accent + "22", color: C.accent, fontWeight: 700, fontSize: 13, padding: "3px 10px", borderRadius: 6 }}>QUESTION 17</span></div>
    ...
    <p style={{ fontSize: 15.5, lineHeight: 1.8, color: C.text, margin: "0 0 0" }}>Find the complete set of values of <Tex>{"x"}</Tex> for which there are two non-congruent triangles with the side lengths and angle as shown in the diagram.</p></div>
