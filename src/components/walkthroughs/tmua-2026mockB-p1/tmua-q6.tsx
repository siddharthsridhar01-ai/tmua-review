...
const META = { questionNumber: 6, set: "B", paperNumber: "Paper 1", topicTag: "Binomial Expansion / Parity" };
...
const SECTIONS_Q6 = [
  { type: "prose", text: (<>In the expansion of</>) },
  { type: "mathbox", tex: "(3 + x)^8" },
  { type: "prose", text: (<>how many of the terms have an odd coefficient?</>) },
];
const OPTIONS_Q6 = [["A", "0"], ["B", "1"], ["C", "2"], ["D", "3"], ["E", "4"], ["F", "5"]];
