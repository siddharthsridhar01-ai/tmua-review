...
export const papers: Record<string, { title: string; source: string; questions: Question[] }> = {
  "tmua-2026mockA-p1": {
    title: "AceAdmissions TMUA Mock Set A Paper 1",
  ...
  "tmua-2026mockA-p2": {
    title: "AceAdmissions TMUA Mock Set A Paper 2",
    source: "AceAdmissions Mock",
    questions: [
      ...
      { displayNum: 4, topic: "Logic & Reasoning", correctAnswer: "F", hasWalkthrough: true,
        text: "Proof that n\u00B3+n is divisible by 6. Which line has the first error?",
      ...
      { displayNum: 5, topic: "Logic & Reasoning", correctAnswer: "H", hasWalkthrough: true,
        text: "Line y=mx+(3-2m) through (2,3). Which of P, converse, contrapositive are true?",
      ...
      { displayNum: 6, topic: "Logic & Reasoning", correctAnswer: "B", hasWalkthrough: true,
        text: "P: xy>0. Q: x>0 and y>0. Which describes P's relationship to Q?",
      ...
      { displayNum: 7, topic: "Coordinate Geometry", correctAnswer: "E", hasWalkthrough: true,
        text: "Line ax+by=c has negative gradient and positive y-intercept. Necessary but not sufficient condition?",
      ...
      { displayNum: 8, topic: "Sequences & Series", correctAnswer: "C", hasWalkthrough: true,
        text: "Smallest n so any n terms from 2,5,8,\u2026,50 must contain two summing to 52.",
      ...
      { displayNum: 11, topic: "Logic & Reasoning", correctAnswer: "A", hasWalkthrough: true,
        text: "Proof that \u221A2 is irrational. What best describes this attempt?",
      ...
      { displayNum: 14, topic: "Algebra", correctAnswer: "C", hasWalkthrough: true,
        text: "(p\u00B2-3)x = p+\u221A3 has a unique solution. Complete set of values of p?",
      ...
      { displayNum: 17, topic: "Logic & Reasoning", correctAnswer: "B", hasWalkthrough: true,
        text: "Claimed proof about cubic x\u00B3-3x\u00B2+c. What best describes it?",
  ...
  "tmua-2026mockB-p1": {
    title: "AceAdmissions TMUA Mock Set B Paper 1",
    source: "AceAdmissions Mock",
    questions: [
